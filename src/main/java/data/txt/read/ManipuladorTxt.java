...
public class ManipuladorTxt {
    ...
    public static void carregarDadosTreino(@NotNull List<File> files) throws Exception {
        ...
        for (int i = 0; i < doubles.size(); i++) {
            ...
            int jO = 0;
            for (int j = 0; j < doubles.get(i).length; j++) {
                if (colunasDeEntrada.contains(j)) {
                    valorEntradaTreino[i][jI] = doubles.get(i)[j];
                    jI++;
                }
                if (colunasDeSaida.contains(j)) {
                    valorSaidaTreino[i][jO] = doubles.get(i)[j];
                    jO++;
                }
            }
        }
  ...
  /*      Operacoes.findMinMaxVals(
                ...
                ConjuntoDados.dadosTreinamento);
*/
        // Debug
        if (Ctrl.isSysLogInputTxt()) {
    ...
    public static void showTxtVals(List<double[]> doubles, boolean train) {
        if (train) {
    ...
    public static double[][] getValorEntradaTreino() {
        return valorEntradaTreino;
    }


    public static double[][] getValorSaidaTreino() {
        return valorSaidaTreino;
    }


    public static double[][] getValorEntradaTeste() {
        return valorEntradaTeste;
    }


    public static double[][] getValorSaidaTeste() {
